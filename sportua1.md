---
layout: matchannels
title: "El stream de Sport 1 (Ukrania)"
description: "Sport 1 (Ukrania) stream requires ace-player to be installed, para ver el stream de Sport 1 (Ukrania) necesita descargar ace-player del sitio http://acestream.org"
author: abuseombudsman
---
# El stream de Sport 1 (Ukrania)
<html>
<head>
	
	<tr>
		<td>
			<span><img src="images/sport.ukrania-1.png" height="40px" style="margin-right:10px;"></span>
		</td>
		<td>
...
<body>
		...
		function init() {
			...
			try {
					...
					onLoad: function() {
						...
						try {
							var p = this;
							this.loadPlayer("f2d323c2256901c2523f5b984ca991371aef39e3", {autoplay: true});
						}
						catch(e) {
						console.log("init: " + e);
						}
	...
	<div id="aceplayer">
		...
		<script type="text/javascript">
			...
			plugin.playlistLoadAsyncPlayer("f2d323c2256901c2523f5b984ca991371aef39e3");
		</script>
	</div>
</body>
<html>