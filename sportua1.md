---
layout: matchannels
title: "Sport 1 UA acestream"
description: "Sport 1 UA acestream requires ace-player to be installed, para ver la señal de Sport 1 UA acestream necesita descargar ace-player del sitio http://acestream.org"
author: abuseombudsman
---
# Sport 1 UA acestream
<html>
<head>
...
<body>
		...
		function init() {
			...
			try {
					...
					onLoad: function() {
						...
						try {
							var p = this;
							this.loadPlayer("ee0fae15081af110e6ead3dd58bf7a28da0f7e95", {autoplay: true});
						}
						catch(e) {
						console.log("init: " + e);
						}
	...
	<div id="aceplayer">
		...
		<script type="text/javascript">
			...
			plugin.playlistLoadAsyncPlayer("ee0fae15081af110e6ead3dd58bf7a28da0f7e95");
		</script>
	</div>
</body>
<html>