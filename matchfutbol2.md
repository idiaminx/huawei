---
layout: matchannels
title: "Match FUTBOL 2 acestream"
description: "Match FUTBOL 2 acestream requires ace-player to be installed, para ver la señal de Match FUTBOL 2 acestream necesita descargar ace-player del sitio http://acestream.org"
author: abuseombudsman
---
# Match FUTBOL 2 acestream
<html>
<head>
	
	<tr>
		<td>
			<span><img src="images/Match!Fùtbol-2HD.png" height="40px" style="margin-right:10px;"></span>
		</td>
		<td>
...
<body>
		...
		function init() {
			...
			try {
					...
					onLoad: function() {
						...
						try {
							var p = this;
							this.loadPlayer("9336038e37cfcac65a59b464ee834858914a2a11", {autoplay: true});
						}
						catch(e) {
						console.log("init: " + e);
						}
	...
	<div id="aceplayer">
		...
		<script type="text/javascript">
			...
			plugin.playlistLoadAsyncPlayer("9336038e37cfcac65a59b464ee834858914a2a11");
		</script>
	</div>
</body>
<html>