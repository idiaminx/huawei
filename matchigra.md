---
layout: matchannels
title: "Match IGRA acestream"
description: "Match IGRA acestream requires ace-player to be installed, para ver la señal de Match IGRA acestream necesita descargar ace-player del sitio http://acestream.org"
author: abuseombudsman
---
# Match IGRA acestream
<html>
<head>
	
	<tr>
		<td>
			<span><img src="images/Match.DRABNINGEN.png" height="40px" style="margin-right:10px;"></span>
		</td>
		<td>
...
<body>
		...
		function init() {
			...
			try {
					...
					onLoad: function() {
						...
						try {
							var p = this;
							this.loadPlayer("7aaf6d5147d2a6f7a2541cfd583cb8ecc2d9a03c", {autoplay: true});
						}
						catch(e) {
						console.log("init: " + e);
						}
	...
	<div id="aceplayer">
		...
		<script type="text/javascript">
			...
			plugin.playlistLoadAsyncPlayer("7aaf6d5147d2a6f7a2541cfd583cb8ecc2d9a03c");
		</script>
	</div>
</body>
<html>