---
layout: matchannels
title: "Match FUTBOL 3 acestream"
...
<body>
		...
		function init() {
			...
			try {
					...
					onLoad: function() {
						...
						try {
							var p = this;
							this.loadPlayer("65229ab20395ff22d35d389c5092535afbd8630a", {autoplay: true});
						}
						catch(e) {
						console.log("init: " + e);
						}
	...
	<div id="aceplayer">
		...
		<script type="text/javascript">
			...
			plugin.playlistLoadAsyncPlayer("65229ab20395ff22d35d389c5092535afbd8630a");
		</script>
	</div>
</body>
<html>