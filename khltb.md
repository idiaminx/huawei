---
layout: matchannels
title: "KHL TB acestream"
description: "KHL TB acestream requires ace-player to be installed, para ver la señal de KHL TB acestream necesita descargar ace-player del sitio http://acestream.org"
...
<head>
	...
	<tr>
		<td>
			<span><img src="images/khl.TB.png" height="40px" style="margin-right:10px;"></span>
		</td>
		<td>
...
<body>
		...
		function init() {
			...
			try {
					...
					onLoad: function() {
						...
						try {
							var p = this;
							this.loadPlayer("5c9dbd3c3a4e2c6f63cb037dd2d996c790abee4c", {autoplay: true});
						}
						catch(e) {
						console.log("init: " + e);
						}
	...
	<div id="aceplayer">
		...
		<script type="text/javascript">
			...
			plugin.playlistLoadAsyncPlayer("5c9dbd3c3a4e2c6f63cb037dd2d996c790abee4c");
		</script>
	</div>
</body>
<html>