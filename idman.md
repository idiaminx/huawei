---
layout: matchannels
title: "Idman Sport acestream"
description: "Idman Sport acestream requires ace-player to be installed, para ver la señal de Idman Sport acestream necesita descargar ace-player del sitio http://acestream.org"
author: abuseombudsman
---
# Idman Sport acestream
<html>
<head>
	
	<tr>
		<td>
			<span><img src="images/iDMAN.Sport.png" height="40px" style="margin-right:10px;"></span>
		</td>
		<td>
...
<body>
		...
		function init() {
			...
			try {
					...
					onLoad: function() {
						...
						try {
							var p = this;
							this.loadPlayer("4909cec2f28f50f5f801594ef85dd634edcc79ad", {autoplay: true});
						}
						catch(e) {
						console.log("init: " + e);
						}
	...
	<div id="aceplayer">
		...
		<script type="text/javascript">
			...
			plugin.playlistLoadAsyncPlayer("4909cec2f28f50f5f801594ef85dd634edcc79ad");
		</script>
	</div>
</body>
<html>